				 ...
				 /  html :
					...
					body: [
						...
						},
						{
							...
							onselect: function( ) {
			                    var GridOptions = tieinstaWin.find('#hashtag');
			                    var GridOptions = tieinstaWin.find('#hashtagName');

			                    var SliderSpeed = tieinstaWin.find('#Username');
			                    var SliderAnima = tieinstaWin.find('#InfoArea');
			                    var SliderMedia = tieinstaWin.find('#InfoLayout');
			                    var SliderMedia = tieinstaWin.find('#Website');
			                    var SliderMedia = tieinstaWin.find('#bio');
			                    var SliderMedia = tieinstaWin.find('#Stats');
			                    var SliderMedia = tieinstaWin.find('#Position');
			                    var SliderMedia = tieinstaWin.find('#FullName');
			                    var SliderMedia = tieinstaWin.find('#AvatarShape');
			                    var SliderMedia = tieinstaWin.find('#AvatarSize');
						...
						},
						{
							...
							onselect: function( ) {
			                    var GridOptions = tieinstaWin.find('#GridColumns');

			                    var SliderSpeed = tieinstaWin.find('#GridColumns');
			                    var SliderAnima = tieinstaWin.find('#GridColumns');
			                    var SliderMedia = tieinstaWin.find('#GridColumns');
			                    ...
			                    if (this.value() == 'slider') {
									...
									tinyMCE.DOM.setStyle( 'SliderSpeed',	'opacity', '1');     
									tinyMCE.DOM.setStyle( 'SliderSpeed-l',	'opacity', '1');
									tinyMCE.DOM.setStyle( 'SliderAnima',	'opacity', '1');     
									tinyMCE.DOM.setStyle( 'SliderAnima-l',	'opacity', '1');
									tinyMCE.DOM.setStyle( 'SliderMedia',	'opacity', '1');     
									tinyMCE.DOM.setStyle( 'SliderMedia-l',	'opacity', '1');
			                    } 
			                    else {
									
									tinyMCE.DOM.setStyle( 'GridColumns-l',	'opacity', '1');
									tinyMCE.DOM.setStyle( 'GridColumns',	'opacity', '1');
					...
					onsubmit: function( e ) {
						...
						//if( e.data.mediaFrom )			output += ' source= ' + e.data.mediaFrom; 
